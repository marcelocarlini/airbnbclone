...
const Card = (props) => {
    const mappingImg = props.item.images ?
        props.item.images.map((i, k) => (
            ...
            <img className='d-block w-100 rounded slideImg' alt='' src="https://plus.unsplash.com/premium_photo-1664464228938-0fcef7296c95?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80" />
